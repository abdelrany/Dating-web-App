  ...
  return (
        <article className='group relative h-[340px] rounded-md overflow-hidden shadow-md flex flex-col bg-white'>
            ...
            <div className='flex-[.1] px-2 py-4 flex justify-between items-center'>
                <EnvelopeIcon className='w-6 h-6 text-primary cursor-pointer'/>
                <FireIcon className='w-6 h-6 text-primary cursor-pointer'/>
                <EyeIcon className='w-6 h-6 text-primary cursor-pointer'/>
                <StarIcon className='w-6 h-6 text-primary cursor-pointer z-10'/>
            </div>
