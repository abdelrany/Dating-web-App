...
const UnloggedHome = (props: Props) => {
  return (
    <section className=''>
       ...
       <div className='py-8 md:px-12 lg:px-32 mb-12 h-[75vh]'>
           <h1 className='font-extrabold text-4xl text-center text-gray-100 w-[350px] mb-4'>Find Real Love in Real Time at a Click</h1>
           <Form/>
           <div className='absolute bottom-44 right-32 flex items-center rounded-md bg-gray-100 w-90 h-16'>
               <Image src={privacyImg} alt="privacy" className='h-full w-32' />
               <Image src={secureImg} alt="privacy" className='h-full w-44' />
           </div>
       </div>
        <div className='h-28 bg-gray-100 flex items-center justify-around md:px-12 lg:px-32 '>
                <div className='flex flex-col justify-center items-center translate-y-[-40px] gap-4'>
                    ...
                    <h1 className='text-center font-extrabold text-dark'>Sign Up and Get Started</h1>
                </div>
                <div className='flex flex-col justify-center items-center translate-y-[-40px] gap-4'>
                    <div className='flex justify-center items-center w-12 h-12 rounded-full bg-primary group hover:bg-gray-100 duration-300'>
                        <ChatBubbleOvalLeftIcon className='h-6 w-6 text-gray-100 group-hover:text-primary'/> 
                    </div>
                    <h1 className='text-center font-extrabold text-dark'>Unlock "Ready To Chat"</h1>
                </div>
                <div className='flex flex-col justify-center items-center translate-y-[-40px] gap-4'>
                    ...
                    <h1 className='text-center font-extrabold text-dark'>Invite your match to date</h1>
                </div>
        </div>
        <Features/>
    </section>
